...
from src.demo.backend.demo_app.demo_app.data_utils.utils import predict_with_fc, predict_with_lr, get_average_word_embeddings, train_lr, predict_with_transformer
...
class PredictionView(View):
    def post(self, request):
        ...
        # for trait in personality_traits:
        #     result = predict_with_transformer(text, trait)
        #     response[trait] = result
